...
$sql = "SELECT livres.titre, livres.auteur, liste_lecture.date_emprunt, livres.id
FROM liste_lecture
        ...
        <div>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="livre">
                    ...
                    <div class="actions">
                        <button onclick="window.location.href='lire.php?id=<?php echo $row['id']; ?>'" class="btn">Lire</button>
